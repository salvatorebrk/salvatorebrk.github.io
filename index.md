...
Expert in developing **bootloader solutions**, implementing communication protocols (CAN, UDS, XCP), and ensuring compliance with safety standards like **ISO26262 (ASIL D)**.
Skilled in low-level programming (C, Assembly), PCB design, and debugging complex hardware/software architectures. I thrive in multidisciplinary teams and value technical precision and reliability.
...
| Category | Skills |
|:--- |:--- |
| **Programming** | C, C++ (Embedded), Python, LUA, Bash Scripting, Assembly |
| **Microcontrollers** | Infineon Aurix (TC2XX/TC3XX), ARM Cortex (M0/M4), Atmel AVR/SAM, NXP, Nordic nRF |
| **Protocols** | CAN/CAN-FD, UDS, XCP, SPI, I2C, UART, RS-485, Ethernet, BLE, MQTT |
| **Standards** | ISO26262 (Functional Safety), MISRA C:2012, AUTOSAR |
| **Tools & IDE** | Visual Studio Code, Trace32, Vector Suite, Jira, Git, SVN, Keil, Atmel Studio |
| **Hardware** | PCB Design (EagleCad), Oscilloscope, Logic Analyzer, Soldering (SMD) |
| **OS** | Linux (Embedded/Yocto), FreeRTOS, Windows |

## Contact

- **Email:** [salvatorebrk@gmail.com](mailto:salvatorebrk@gmail.com)
- **GitHub:** [github.com/salvatorebrk](https://github.com/salvatorebrk)
- **LinkedIn:** [linkedin.com/in/salvatore-bruccoleri](https://it.linkedin.com/in/salvatore-bruccoleri)
